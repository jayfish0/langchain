...
class ClickToolInput(BaseModel):
    """Input for AgentQL's Click Tool"""

    query: Optional[str] = Field(default=None, description="The AgentQL query to query the target clickable element")
...
class ClickTool(BaseBrowserTool): # type: ignore[override, override, override]
    ...
    def _run(
        ...
        if query:
            ...
            element.click(
                force=self.playwright_force_click,
